...
def main():
    ...
    parser.add_argument('--train-file', default='./data/hyperpartisan/articles-training-byarticle-20181122.xml')
    parser.add_argument('--labels-file', default='./data/hyperpartisan/ground-truth-training-byarticle-20181122.xml')
    parser.add_argument('--splits-file', default='./data/hyperpartisan/hp-splits.json')
